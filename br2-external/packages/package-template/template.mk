# This is an example copied from when we loaded libeudev externally.
# It is here just so we don't lose a good reference for an mk file.
# Use it as an example for a new external package.
