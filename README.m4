...
You might now want to rename (since the version number is already in TOP)
   ...
   mv buildroot-2015.02  buildroot-2015.02-x86_64
...
Create symlink to site-specific config files, patches etc.
   ...
   ln -s ../site-top buildroot-2015.02-x86_64/site # if you renamed the unpacked buildroot top then use the name here, of course
...
First, change the working-directory into the buildroot source directory.
  ...
  cd buildroot-2015.02-x86_64/   # or whatever you renamed the directory to
